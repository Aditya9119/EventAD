...
export const addEventToFirebase = async (
	...
	if (flier !== null) {
		await uploadString(imageRef, flier, "data_url").then(async () => {
			// Image url getting from here
			const downloadURL = await getDownloadURL(imageRef);
			// Update the docRef, by adding the logo URL to the document
...
// It accepts the user's email and pasword and create a account for user with the credentials
...
// function allowing the existing user to access the application
...
// Allow the users to logout of the application.
